...
export const metadata = {
  title: "InstaCop — check an Instagram seller before you pay",
  description:
    ...
    <html lang="en">
      <body>
        <header className="site-header">
          <a href="/" className="logo">InstaCop</a>
          <span className="tagline">check before you pay</span>
        </header>
        <main>{children}</main>
        <footer className="site-footer">
          <p>
            InstaCop scores are automated pattern analysis of publicly available information,
            ...
            or takedowns at <a href="mailto:grievance@instacop.shop">grievance@instacop.shop</a>;
